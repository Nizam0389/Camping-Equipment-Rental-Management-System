...
<nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700" class="navbar a:hover::after" style="background-color: #4F6F52;">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4" style="background-color: #4F6F52;">
            <a href="homepage.php" class="flex items-center space-x-3 rtl:space-x-reverse" style="background-color: #4F6F52;">
                <img src="image\logo.png" style="border-radius: 50%; height: 40px" class="h-8" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white" style="color: white;">SYAKIRI CAMPING</span>
            </a>
            <button data-collapse-toggle="navbar-dropdown" style="background-color: #4F6F52;" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-dropdown" aria-expanded="false">
