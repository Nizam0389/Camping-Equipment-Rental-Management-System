...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <div class="item-card">
                <img src="image/bed image/camping air basic 1 person.png">
                <h3>Camping Air Basic 1 Person</h3>
                <p>RM10 per day</p>
                <a href="addToCart.html">add to cart</a>
            </div>
            <div class="item-card">
                <img src="image/bed image/camping air basic 2 person.png">
                <h3>Camping Air Basic 2 Person</h3>
                <p>RM20 per day</p>
                <a href="addToCart.html">add to cart</a>
            </div>
            <div class="item-card">
                <img src="image/bed image/single sleeping bed.png">
        ...
        <div class="container">
            <div class="item-card">
                <img src="image/bed image/laybed.png">
                <h3>Laybed</h3>
                <p>RM25 per day</p>
                <a href="addToCart.html">add to cart</a>
            </div>
            <div class="item-card">
                <img src="image/bed image/family sleeping bed.png">
