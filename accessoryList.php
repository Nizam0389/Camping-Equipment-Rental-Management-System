...
<head>
    ...
    <script>
        ...
        function addToCart(itemId, itemName, itemPrice) {
            ...
            item.innerHTML = `
                <img src="image/accessory image/${itemId}.png" alt="${itemName}">
                <span>${itemName}</span>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <div class="item-card">
                <img src="image/accessory image/ground_sheet.png" alt="Groundsheet">
                <h3>Groundsheet</h3>
                <p>RM10 per day</p>
                <button onclick="addToCart('ground_sheet', 'Groundsheet', 10)">Add to Cart</button>
            </div>
            <div class="item-card">
                <img src="image/accessory image/low_folding_camping_chair.png" alt="Low Folding Camping Chair">
            ...
            <div class="item-card">
                <img src="image/accessory image/large_folding_camping_chair.png" alt="Large Folding Camping Chair">
        ...
        <div class="container">
            <div class="item-card">
                <img src="image/accessory image/camping_lamp.png" alt="Camping Lamp rechargeable">
            ...
            <div class="item-card">
                ...
                <h3>Torch Light</h3>
                <p>RM1 per day</p>
                <button onclick="addToCart('torch', 'Torch Light', 1)">Add to Cart</button>
            </div>
            <div class="item-card">
