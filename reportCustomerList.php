...
$sql = "SELECT * FROM customer LIMIT $start_from, $limit";
$result = $dbCon->query($sql);

// Get total records
$sqlTotal = "SELECT COUNT(cust_id) FROM customer";
...
<body>
    ...
    <div class="main-content">
        ...
        <input type="text" id="searchBar" onkeyup="searchTable()" placeholder="Search for customers..">
        ...
        <div class="pagination">
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                echo "<a href='reportCustomerList.php?page=" . $i . "'";
