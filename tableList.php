...
<head>
    ...
    <script>
        ...
        function addToCart(itemId, itemName, itemPrice) {
            ...
            item.innerHTML = `
                <img src="image/table image/${itemId}.png" alt="${itemName}">
                <span>${itemName}</span>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <div class="item-card">
                <img src="image/table image/foldable_aluminium_table.png" alt="Foldable Aluminium Table">
                <h3>Foldable Aluminium Table</h3>
                <p>RM40 per day</p>
                <button onclick="addToCart('foldable_aluminium_table', 'Foldable Aluminium Table', 40)">Add to Cart</button>
            </div>
            <div class="item-card">
                <img src="image/table image/foldable_aluminium_alloy_table.png" alt="Folfable Aluminium Alloy Table">
                <h3>Foldable Aluminium Alloy Table</h3>
                <p>RM40 per day</p>
                <button onclick="addToCart('foldable_aluminium_alloy_table', 'Folfable Aluminium Alloy Table', 40)">Add to Cart</button>
            </div>
            <div class="item-card">
                <img src="image/table image/wooden_eggroll_table.png" alt="Wooden Eggroll Table">
                <h3>Wooden Eggroll Table</h3>
                <p>RM40 per day</p>
                <button onclick="addToCart('wooden_eggroll_table', 'Wooden Eggroll Table', 40)">Add to Cart</button>
            </div>
        </div>
        <div class="container">
            <div class="item-card">
                <img src="image/table image/multifunction_folding_table.png" alt="Multifunction Folding Table">
                <h3>Multifunction Folding Table</h3>
                <p>RM20 per day</p>
                <button onclick="addToCart('multifunction_folding_table', 'Multifunction Folding Table', 20)">Add to Cart</button>
            </div>
            <div class="item-card">
                <img src="image/table image/small_foldable_aluminium_table.png" alt="Small Foldable Aluminium Table">
                <h3>Small Foldable Aluminium Table</h3>
                <p>RM20 per day</p>
                <button onclick="addToCart('small_foldable_aluminium_table', 'Small Foldable Aluminium Table', 20)">Add to Cart</button>
            </div>
        </div>
    </div>
    <div class="cartTab">
